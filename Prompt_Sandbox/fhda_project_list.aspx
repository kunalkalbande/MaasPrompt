    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Using db As New PromptDataHelper
            ...
            For Each rproject As DataRow In rs.Rows
                ...
                cc = New TableCell
                cc.Text = strImage & "<a target='_new' href='fhda_project_view.aspx?ProjectID=" & rproject("ProjectID") & "'>" & rproject("Title") & "</a>"
                cc.Wrap = False
...
<body >
    <form id="Form1" method="post" runat="server">
        <asp:Table ID="tblList" runat="server" Width="98%" BorderColor="#E0E0E0" BorderStyle="Solid" BorderWidth="1px" GridLines="Horizontal">
