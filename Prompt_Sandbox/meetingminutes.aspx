...
<script runat="server">
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If nProjectID = 0 Then
            pageType = "DistrictMinutes"
        Else
            pageType = "MeetingMinutes"
        End If
        'set security
        Using dbsec As New EISSecurity
            dbsec.ProjectID = nProjectID
            If dbsec.FindUserPermission(pageType, "write") Then
                bReadOnly = False
            Else
                bReadOnly = True
            End If
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If nProjectID = 0 Then
            Session("CurrentTab") = "DistrictMinutes"
        Else
    ...
    Private Sub BuildMenu()
        ...
        If Not IsPostBack Then          'Configure Tool Bar
            ...
            With but
                ...
                .Attributes("onclick") = "return EditMeeting(" & nProjectID & ",0,'New');"
    ...
    Protected Sub RadGrid1_NeedDataSource(ByVal source As Object, ByVal e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles RadGrid1.NeedDataSource
        ...
        'errorMsg.Text = nProjectID & " - " & nCollegeID & " - " & Session("CollegeID") & " - " & Session("DistrictID")
        
        Using db As New MeetingMinute
            RadGrid1.DataSource = db.GetAllProjectMeetingMinutes(nProjectID, Session("CollegeID"), Session("DistrictID"))
        End Using
    ...
    Protected Sub RadGrid1_ItemCreated(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridItemEventArgs) Handles RadGrid1.ItemCreated
        ...
        If (TypeOf e.Item Is GridDataItem) Then
            ...
            Else
                ...
                linkButton.Attributes("onclick") = "return EditMeeting(" & nProjectID & "," & nMeetingID & ",'Existing');"
            End If
           
            'Note: These do not use rad windows as they are external opens
            If Not sMinutes = "None Selected" Then
                ...
                'sPath = "/PromptAttachments/DistrictID_" & HttpContext.Current.Session("DistrictID") & "/_apprisedocs/"
                sPath &= "_meetingminutes/ProjectID_" & nProjectID & "/meetingID_" & nMeetingID & "/"
...
<telerik:RadGrid ID="RadGrid1" runat="server" AllowSorting="True" AutoGenerateColumns="False"
    ...
    <MasterTableView Width="100%" GridLines="None" DataKeyNames="MeetingID,MinutesFileName,MeetingDate,MeetingNumber,DesignPhase,PhaseSubCategory,OrganizerName" NoMasterRecordsText="No Meeting Minutes found.">
        <Columns>
           <telerik:GridHyperLinkColumn UniqueName="MeetingDate" HeaderText="Date" DataTextField="MeetingDate"  SortExpression="MeetingDate" DataTextFormatString="{0:MM/dd/yy}">
            ...
            <telerik:GridBoundColumn UniqueName="MeetingID" HeaderText="Meeting ID" DataField="MeetingNumber">
                <ItemStyle HorizontalAlign="Left" Width="110px"/>
                <HeaderStyle HorizontalAlign="Left" Width="110px" />
            </telerik:GridBoundColumn>

            <telerik:GridBoundColumn UniqueName="OrganizerName" HeaderText="Organizer" DataField="OrganizerName">
                <ItemStyle HorizontalAlign="Left" Width="150px"/>
                <HeaderStyle HorizontalAlign="Left" Width="150px" />
            </telerik:GridBoundColumn>

            <telerik:GridBoundColumn UniqueName="DesignPhase" HeaderText="Phase" DataField="DesignPhase">
                <ItemStyle HorizontalAlign="Left" Width="130px"/>
                <HeaderStyle HorizontalAlign="Left" Width="130px" />
            </telerik:GridBoundColumn>      

            <telerik:GridBoundColumn UniqueName="PhaseSubCategory" HeaderText="Sub-Phase" DataField="PhaseSubCategory">
                <ItemStyle HorizontalAlign="Left" Width="130px"/>
                <HeaderStyle HorizontalAlign="Left" Width="130px" />
            </telerik:GridBoundColumn>      
...
<script type="text/javascript" language="javascript">
    ...
    function EditMeeting(projectid,id,displaytype) {

        var oWnd = window.radopen("meetingminutes_edit.aspx?ProjectID=" + projectid + "&MeetingID=" + id + "&DisplayType=" + displaytype, "EditWindow");
        return false;
    }
