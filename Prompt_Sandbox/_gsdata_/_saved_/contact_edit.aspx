...
<script runat="server">
    ...
    Private Sub butSave_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles butSave.Click
        ...
        Using db As New PromptDataHelper
            ...
            db.ExecuteNonQuery("UPDATE Contacts SET Name = '" & txtFirstName.Text & " " & txtLastName.Text & "' WHERE ContactID = " & nContactID)
...
<body>
    ...
    <asp:TextBox ID="txtCell" Style="z-index: 127; left: 90px; position: absolute; top: 361px;
        right: 1397px; bottom: 520px;" TabIndex="17" runat="server" Width="120px" 
...
<telerik:RadComboBox ID="lstContactType" 
    ...
    <asp:HiddenField ID="txtName" runat="server" Value="" />
       ...
       <asp:CheckBox ID="chkInactive" Style="z-index: 102; left: 399px; position: absolute; top: 67px"
