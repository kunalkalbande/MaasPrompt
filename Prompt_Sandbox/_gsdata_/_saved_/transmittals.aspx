...
<script runat="server">
    ...
    Protected Sub Page_PreRender(ByVal sender As Object, ByVal e As System.EventArgs)
        Using db As New promptUserPrefs
            db.SaveGridSettings(RadGrid1, "TransmittalGridSettings", "ProjectID", nProjectID)
        End Using
     End Sub
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Using dbsec As New EISSecurity
            ...
            If dbsec.FindUserPermission("TransmittalLog", "write") Then
                bReadOnly = False
            Else
                bReadOnly = True
            End If
        ...
        If Not IsPostBack Then
            Using db As New promptUserPrefs
                db.LoadGridSettings(RadGrid1, "TransmittalGridSettings", "ProjectID", nProjectID)
                db.LoadGridColumnVisibility(RadGrid1, "TransmittalGridColumns", "ProjectID", nProjectID)
            End Using
        End If
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Session("CurrentTab") = "Transmittals"
        For Each radTab In masterTabs.GetAllTabs
            If radTab.Value = "Transmittals" Then
        ...
        With RadGrid1
            ...
            .ExportSettings.FileName = "PromptTransmittalExport"
            .ExportSettings.OpenInNewWindow = True
            .ExportSettings.Pdf.PageTitle = masterViewTitle.Text & " Transmittals"
    ...
    Private Sub BuildMenu()
        ...
        If Not IsPostBack Then          'Configure Tool Bar
            ...
            With but
                ...
                .Attributes("onclick") = "return EditTransmittal('0'," & nProjectID & ");"
                .ToolTip = "Add a New Transmittal."
                .PostBack = False
                If bReadOnly Then
                    .Visible = False
                Else
            ...
            'butSub = New RadMenuItem
            'With butSub
            '    .Text = "Print Transmittal Log"
            '    .ImageUrl = "images/printer.png"
            '    .Target = "_new"
            '    .NavigateUrl = "http://216.129.104.66/Q34JF8SFA/Pages/ReportViewer.aspx?%2fPromptReports%2fTransmittal_log&Dist=56&Proj=" & nProjectID
            '    .PostBack = False
            'End With
            'butDropDown.Items.Add(butSub)
    ...
    Protected Sub RadGrid1_NeedDataSource(ByVal source As Object, ByVal e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles RadGrid1.NeedDataSource
        ...
        Using db As New Transmittal
            RadGrid1.DataSource = db.GetAllProjectTransmittals(nProjectID)
        End Using
    ...
    Protected Sub RadGrid1_ItemCreated(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridItemEventArgs) Handles RadGrid1.ItemCreated
        ...
        If (TypeOf e.Item Is GridDataItem) Then
            ...
            Dim nTransmittalID As Integer = item.OwnerTableView.DataKeyValues(item.ItemIndex)("TransmittalID")
            ...
            If bReadOnly Then
                item("TransmittalID").Controls.Clear()
                item("TransmittalID").Text = nTransmittalID
            Else
                linkButton = CType(item("TransmittalID").Controls(0), HyperLink)
                linkButton.Attributes("onclick") = "return EditTransmittal(" & nTransmittalID & "," & nProjectID & ");"
                linkButton.NavigateUrl = "#"
                'linkButton.ToolTip = "Edit this Transmittal."
            End If
            ...
            linkButton.Attributes("onclick") = "return ManageAttachments('" & nTransmittalID & "','" & nProjectID & "');"

            If sAttachments = "Y" Then    'add link for each file
                linkButton.ImageUrl = "images/paper_clip_small.gif"
            End If
            
            'Dim printButton As HyperLink
            'printButton = CType(item("PrintMe").Controls(0), HyperLink)
            'printButton.ToolTip = "Print this Transmittal"
            ...
            'printButton.Attributes("onclick") = "window.open('" & url & "')"
            'printButton.ImageUrl = "images/printer.png"
    ...
    Private Sub RadGrid1_ItemDataBound(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridItemEventArgs) Handles RadGrid1.ItemDataBound
        If (TypeOf e.Item Is GridDataItem) Then
            ...
            '    dataItem.CssClass = "Transmittal_pending"
            ...
            '            dataItem.CssClass = "Transmittal_overdue"
    ...
    Protected Sub RadMenu1_ItemClick(ByVal sender As Object, ByVal e As Telerik.Web.UI.RadMenuEventArgs)
        ...
        Select Case btn.Value
            ...
            Case "ColumnVisibility"
                ...
                End If
                Using db As New promptUserPrefs
                    db.SaveGridColumnVisibility("TransmittalGridColumns", btn.Attributes("ID"), btn.Attributes("Visibility"), "ProjectID", nProjectID)
                End Using
                RadGrid1.Rebind()
            ...
            Case "RestoreDefaultSettings"
                ...
                Using db As New promptUserPrefs
                    db.RemoveUserSavedSettings("TransmittalGridSettings", "ProjectID", nProjectID)
                    db.RemoveUserSavedSettings("TransmittalGridColumns", "ProjectID", nProjectID)
                End Using
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainBody" runat="Server">
  ...
  <%--   <div id="contentwrapper">
    ...
    <MasterTableView Width="100%" GridLines="None" DataKeyNames="TransmittalID,Attachments" NoMasterRecordsText="No Transmittal Entries found.">
        <Columns>
  
            <telerik:GridHyperLinkColumn UniqueName="TransmittalID" HeaderText="ID" DataTextField="TransmittalID" SortExpression="TransmittalID">
                <ItemStyle HorizontalAlign="Left" Width="50px" VerticalAlign="Top" />
                <HeaderStyle HorizontalAlign="Left" Width="50px" />
            </telerik:GridHyperLinkColumn>
            
<%--            <telerik:GridHyperLinkColumn UniqueName="PrintMe" HeaderText=" ">
                <ItemStyle HorizontalAlign="Left" Width="50px" VerticalAlign="Top" />
                <HeaderStyle HorizontalAlign="Left" Width="50px" />
            </telerik:GridHyperLinkColumn>
            
--%>
            <telerik:GridBoundColumn DataField="TransmittedOn" HeaderText="Date" UniqueName="TransmittedOn" SortExpression="TransmittedOn"
            ...
            <telerik:GridBoundColumn UniqueName="ToName" HeaderText="To" DataField="ToName">
                <ItemStyle HorizontalAlign="Left" Width="75px" VerticalAlign="Top" />
                <HeaderStyle HorizontalAlign="Left" Width="75px" />
            </telerik:GridBoundColumn>
 
            <telerik:GridBoundColumn UniqueName="FromName" HeaderText="From" DataField="FromName">
                <ItemStyle HorizontalAlign="Left" Width="15%" VerticalAlign="Top" />
                <HeaderStyle HorizontalAlign="Left" Width="15%" />
            </telerik:GridBoundColumn>
 
            <telerik:GridBoundColumn UniqueName="CopiesDescription1" HeaderText="Item1 Descr" DataField="CopiesDescription1">
                <ItemStyle HorizontalAlign="Left" Width="40%" VerticalAlign="Top" />
                <HeaderStyle HorizontalAlign="Left" Width="40%" />
            </telerik:GridBoundColumn>
            
              
            <telerik:GridBoundColumn UniqueName="ReviewInstructions" HeaderText="Instructions" DataField="ReviewInstructions">
        ...
        <script type="text/javascript" language="javascript">
           ...
           // End ******************* Menu Handlers ***********************
             ...
             function ManageAttachments(id)     //for attachments info display
             {
                 ...
                 var oWnd = window.radopen("apprisepm_attachments_manage.aspx?ParentType=Transmittal&ParentID=" + id, "AttachmentsWindow");
                 return false;
             }

             function EditTransmittal(id,projectid) {

                 var oWnd = window.radopen("transmittal_edit.aspx?ProjectID=" + projectid + "&TransmittalID=" + id, "EditWindow");
                 return false;
             }
        </script>
