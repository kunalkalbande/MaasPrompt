...
<script runat="server">
    ...
    Protected Sub Page_PreRender(ByVal sender As Object, ByVal e As System.EventArgs)
        Using db As New promptUserPrefs
            db.SaveGridSettings(RadGrid1, "CompaniesGridSettings", "DistrictID", Session("DistrictID"))
        End Using
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If Not IsPostBack Then
            Using db As New promptUserPrefs
                db.LoadGridSettings(RadGrid1, "CompaniesGridSettings", "DistrictID", Session("DistrictID"))
                db.LoadGridColumnVisibility(RadGrid1, "CompaniesGridColumns", "DistrictID", Session("DistrictID"))
            End Using
        End If
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Session("PageID") = "CompaniesList"
        Page.Title = "Prompt Companies"
        ...
        With RadGrid1
            ...
            .ExportSettings.Pdf.PageTitle = "PROMPT Companies List"
        End With
    ...
    Private Sub BuildMenu()
        ...
        If Not IsPostBack Then          'Configure Tool Bar
            ...
            With but
                ...
                .Attributes("onclick") = "return EditCompany('0');"
    ...
    Protected Sub RadGrid1_NeedDataSource(ByVal source As Object, ByVal e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles RadGrid1.NeedDataSource
        ...
        Using db As New PromptDataHelper
            ...
            RadGrid1.DataSource = db.ExecuteDataTable("SELECT * FROM Contacts WHERE DistrictID = " & Session("DistrictID") & " AND ContactType = 'Company' ORDER BY Name")
    ...
    Protected Sub RadGrid1_ItemCreated(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridItemEventArgs) Handles RadGrid1.ItemCreated
        ...
        If (TypeOf e.Item Is GridDataItem) Then
            ...
            If bReadOnly = False Then
                ...
                linkButton.Attributes("onclick") = "return EditCompany(" & nID & ");"
            ...
            If sEmail <> "" Then
                ...
                linkEmail.ToolTip = "Email this Company."
            End If
    ...
    Protected Sub RadMenuPage_ItemClick(ByVal sender As Object, ByVal e As Telerik.Web.UI.RadMenuEventArgs)
        ...
        Select Case btn.Value
            ...
            Case "RestoreDefaultSettings"
                ...
                Using db As New promptUserPrefs
                    db.RemoveUserSavedSettings("CompaniesGridSettings", "DistrictID", Session("DistrictID"))
                    db.RemoveUserSavedSettings("CompaniesGridColumns", "DistrictID", Session("DistrictID"))
                End Using
...
<div class="innertube">
    ...
    <asp:Label ID="lblPageTitle" runat="server" CssClass="companies_lbl" Style="float:left;margin: 10px 10px 5px 10px;">Companies</asp:Label><br /><br />
    ...
    <telerik:RadGrid ID="RadGrid1" runat="server" AllowSorting="true" AutoGenerateColumns="False"
        ...
        <MasterTableView Width="100%" GridLines="None" DataKeyNames="ContactID,Email" NoMasterRecordsText="No Companies found.">
            <Columns>
 ...
 <%--               <telerik:GridBoundColumn UniqueName="Ext" HeaderText="Ext" DataField="Ext">
  ...
  <%--              <telerik:GridBoundColumn UniqueName="Cell" HeaderText="Cell" DataField="Cell">
                ...
                <telerik:GridBoundColumn UniqueName="CompanyType" HeaderText="Type" DataField="CompanyType">
                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
                    <HeaderStyle HorizontalAlign="Left" />
                </telerik:GridBoundColumn>
            </Columns>
    ...
    <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
        ...
        <script type="text/javascript" language="javascript">
            ...
            function EditCompany(id) {
                ...
                var oWnd = window.radopen("company_edit.aspx?ContactID=" + id + "&WinType=RAD", "EditWindow");
                return false;
            }
