...
<script runat="server">
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If Not IsPostBack then
            ...
            'load inbox views dropdown
            item = New ListItem
            item.Text = "My Open Items"
            item.Value = "MyOpenInboxItems"
            item.Selected = True
            cboInboxView.Items.Add(item)

            'item = New ListItem
            'item.Text = "My Pending Items"
            'item.Value = "MyPending"
            'cboInboxView.Items.Add(item)

            'item = New ListItem
            'item.Text = "My Paid Items"
            'item.Value = "MyPaid"
            'cboInboxView.Items.Add(item)
            
            item = New ListItem
            item.Text = "My Approved Items"
            item.Value = "MyApproved"
            cboInboxView.Items.Add(item)
            
            item = New ListItem
            item.Text = "My Rejected Items"
            item.Value = "MyRejected"
            cboInboxView.Items.Add(item)

            If Session("UserRole") = "Project Accountant" Or Session("UserRole") = "TechSupport" Then
                item = New ListItem
                item.Text = "All FDO Approved Items"
                item.Value = "AllFDOApproved"
                cboInboxView.Items.Add(item)
            ...
            If Session("UserRole") = "TechSupport" Then
                item = New ListItem
                item.Text = "All Open Workflow Items"
                item.Value = "AllOpenWorkflowItems"
                cboInboxView.Items.Add(item)
                 ...
                 <telerik:RadDock ID="dockAlerts" runat="server" Width="" Height="" Title="Alerts"
                        ...
                        <TitlebarTemplate>
                            <asp:Label ID="Label1" runat="server" CssClass="widgetalertstitle" Text="Alerts"></asp:Label>
                             <asp:DropDownList ID="cboAlertsView" runat="server" AutoPostBack="true" 
                                onselectedindexchanged="cboAlertsView_SelectedIndexChanged" Width="150px">
                        ...
                        EnableAnimation="true" AutoPostBack="false" EnableRoundedCorners="True" Resizable="false">
                         <Commands>
                          ...
                          <TitlebarTemplate>
                           ...
                           <asp:DropDownList ID="cboInboxView" runat="server" AutoPostBack="True" 
                                onselectedindexchanged="cboInboxView_SelectedIndexChanged" Width="160px">
                            </asp:DropDownList>
