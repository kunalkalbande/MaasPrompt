...
<script runat="server">
    ...
    Private Sub RadGrid1_ItemDataBound(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridItemEventArgs) Handles RadGrid1.ItemDataBound
        ...
        If (TypeOf e.Item Is GridFooterItem) Then
            ...
            footerItem("Credit").Text = FormatCurrency(TotalCredits)
            footerItem("Debit").Text = FormatCurrency(TotalDebits * -1)
            footerItem("Description").Text = "Balance: " & FormatCurrency(TotalAmount) & " &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
...
<telerik:RadGrid ID="RadGrid1" runat="server" AllowSorting="False" AutoGenerateColumns="False"
    ...
    <MasterTableView Width="100%" GridLines="None" NoMasterRecordsText="No Ledger Entries Found."
        ShowHeadersWhenNoRecords="True" DataKeyNames="LedgerAccountID,LedgerEntryID,BudgetObjectCodeID,Debit,Credit,ObjectCode,ProjectName,ProjectNumber,ObjectCodeDescription" ShowFooter="true" FooterStyle-Height="30px">
        <Columns>
            ...
            <telerik:GridBoundColumn DataField="Description" UniqueName="Description" HeaderText="Description">
                <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Width="75%" />
                <HeaderStyle HorizontalAlign="Left" Width="75%" Height="15px" />
                <FooterStyle HorizontalAlign="Right" Width="75%" Height="15px" />
            </telerik:GridBoundColumn>
            
                       <telerik:GridBoundColumn DataField="ProjectName" UniqueName="ProjectName" HeaderText="Project">
                <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Width="75%" />
                <HeaderStyle HorizontalAlign="Left" Width="125px" Height="15px" />
                ...
                <FooterStyle HorizontalAlign="Right" Width="75px" Height="15px" />
            </telerik:GridBoundColumn>
