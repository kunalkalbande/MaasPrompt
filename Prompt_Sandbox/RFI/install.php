	...
	<html>
	<head>
		<title> - created by phpFormGenerator</title>
...
{ ?>
<li class="mainForm"><label class="formFieldQuestion">Hostname&nbsp;&nbsp;</label><input class=mainForm type=text name=dbHostName size='20' value='204.13.83.241'></li><li class="mainForm"><label class="formFieldQuestion">User&nbsp;&nbsp;</label><input class=mainForm type=text name=dbUser size='20' value='maasa'></li><li class="mainForm"><label class="formFieldQuestion">Password&nbsp;&nbsp;</label><input class=mainForm type=text name=dbPassword size='20' value=''></li><li class="mainForm"><label class="formFieldQuestion">Database&nbsp;&nbsp;</label><input class=mainForm type=text name=dbName size='20' value='PromptBeta'></li><li class="mainForm"><label class="formFieldQuestion">Table&nbsp;&nbsp;</label><input class=mainForm type=text name=dbTable size='20' value='RFI'></li><li class="mainForm"><input class=mainForm type=submit name=submit value='Install'></li></form>
<?php }
