...
<script runat="server">
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        BuildMenu()
        'David D 10-13-17 removed below gridgroupby code and instead used telerik controls in the <body>  within <telerik:GridGroupByExpression>
        ...
        'gridGroupByField.FieldName = "MenuNavigation"
        'gridGroupByField.FormatString.Replace(":", "")
        ...
        'Dim sExpression As GridSortExpression = New GridSortExpression()
        'sExpression.FieldName = "ObjectType"
        'sExpression.SortOrder = GridSortOrder.Ascending
        'RadGrid1.MasterTableView.SortExpressions.AddSortExpression(sExpression)
    ...
    Private Sub RadGrid1_ItemDataBound(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridItemEventArgs) Handles RadGrid1.ItemDataBound
        ...
        'David D 10-12-17 Below handles styling of the GridGroupHeaderItem's
...
<body>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
    <asp:Button ID="butExpandCollapse" runat="server" Text="Collapse All" OnClick="butExpandCollapse_Click" />
    <br />
    <telerik:RadGrid ID="RadGrid1" runat="server" AllowSorting="true" AutoGenerateColumns="False"
        ...
        <MasterTableView Width="100%" GridLines="None" GroupsDefaultExpanded=true DataKeyNames="ObjectID,ObjectType,UserID,Category,MenuNavigation,SubMenu,ScopeLevel,Permissions"
            NoMasterRecordsText="No Permissions Found.">
            <GroupByExpressions>
                <telerik:GridGroupByExpression>
                    <SelectFields>
                        <telerik:GridGroupByField FieldAlias="MenuNavigation" FieldName="MenuNavigation"   HeaderText=" " HeaderValueSeparator=" "/>
                    </SelectFields>
                    <GroupByFields>
                    <telerik:GridGroupByField FieldAlias="MenuNavigation" FieldName="MenuNavigation" HeaderText=" " SortOrder=Descending />
                    </GroupByFields>
                </telerik:GridGroupByExpression>
            </GroupByExpressions>
                        <GroupByExpressions>
                <telerik:GridGroupByExpression>
                    <SelectFields>
                        <telerik:GridGroupByField FieldAlias="SubMenu" FieldName="SubMenu" HeaderText=" "   HeaderValueSeparator=" " />
                    </SelectFields>
                    <GroupByFields>
            ...
            <Columns>
                <telerik:GridBoundColumn UniqueName="Description" HeaderText="User Admin Control Groups" DataField="Description">
                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
                    <HeaderStyle HorizontalAlign="Left" />
                </telerik:GridBoundColumn>
                <%--<telerik:GridBoundColumn UniqueName="ObjectType" HeaderText="Object Type" DataField="ObjectType">
                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
                    <HeaderStyle HorizontalAlign="Left" />
                </telerik:GridBoundColumn>--%>
                <telerik:GridTemplateColumn UniqueName="Rights" HeaderText="User Access">
