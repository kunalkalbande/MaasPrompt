...
Namespace Prompt
    ...
    Public Class ProcLib
        ...
        Public Shared Function GetLocale() As String
            ...
            Select Case sname
                Case "PromptSandBox"    'FOR DEBUGG AND DEVELOPMENT on local machine
                    Return "PromptSandBox"
                Case "PromptSandBox.MAASCO.COM"    'production
                    Return "PromptSandBox"
        ...
        Public Shared Function GetServerFooterID() As String
            ...
            Select Case sname
                ...
                Case "APPS.EISPRO.NET"    'OLD production
                    Return "Production"

                Case "PromptSandBox.MAASCO.COM", "PromptSandBox.MAASCO.COM"    'PromptSandBox
        ...
        Public Shared Function GetDataConnectionString() As String
            ...
            Select Case sLocal
                Case "PromptSandBox"    'this is production
                    GetDataConnectionString = System.Configuration.ConfigurationManager.AppSettings("PromptSandBoxConnectionString")




                Case "PromptSandBox"    'this is beat dev site on production server
                    GetDataConnectionString = System.Configuration.ConfigurationManager.AppSettings("PromptSandBoxConnectionString")
        ...
        Public Shared Function GetCurrentAttachmentPath() As String
            ...
            Dim sLocal As String = GetLocale()
            Select Case sLocal
                Case "PromptSandBox"    'this is local 
                    GetCurrentAttachmentPath = System.Configuration.ConfigurationManager.AppSettings("PromptSandBoxAttachmentPath")
        ...
        Public Shared Function GetCurrentRelativeAttachmentPath() As String
            ...
            Select Case sLocal
                Case "PromptSandBox"    'this is production
                    GetCurrentRelativeAttachmentPath = System.Configuration.ConfigurationManager.AppSettings("PromptSandBoxRelativeAttachmentPath")
                Case "PromptSandBox"    'this is beat dev site on production server
                    GetCurrentRelativeAttachmentPath = System.Configuration.ConfigurationManager.AppSettings("BetaRelativeAttachmentPath")


                Case Else    'localhost
                    GetCurrentRelativeAttachmentPath = System.Configuration.ConfigurationManager.AppSettings(UCase(System.Environment.MachineName.ToString) + "LocalRelativeAttachmentPath")
        ...
        Public Shared Function GetCurrentReportPath() As String
            ...
            Select Case sLocal
                Case "PromptSandBox"    'this is production
                    GetCurrentReportPath = System.Configuration.ConfigurationManager.AppSettings("PromptSandBoxReportPath")
                Case "Beta"    'this is beat dev site on production server
        ...
        Public Shared Function GetNonPooledDataConnectionString() As String
            ...
            If GetLocale() = "PromptSandBox" Then   'this is production
                GetNonPooledDataConnectionString = System.Configuration.ConfigurationManager.AppSettings("PromptSandBoxNonPooledConnectionString")
