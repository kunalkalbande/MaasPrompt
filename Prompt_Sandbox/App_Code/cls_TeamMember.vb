...
#Region "Team Members"
        ...
        Public Function getProjectTeamMembersForSubmitToDrop(nProjectID As Integer) As DataTable

            Return Nothing
        End Function

        Public Function GetExistingMembersForDropDowns(ByVal ProjectID As Integer, contactType As String, LnInsert As String) As DataTable
            ...
            sql &= " AND Contacts.ContactType= '" & contactType & "' "
            ...
            newrow("TeamGroupName") = LnInsert
            newrow("Name") = LnInsert

            tblSource.Rows.InsertAt(newrow, 0)   'put it first

            'Dim newrow2 As DataRow = tblSource.NewRow
            'newrow2("ContactID") = 1
            'newrow2("TeamMemberID") = 1
            'newrow2("TeamGroupName") = "Admin Hold"
            'newrow2("Name") = "Admin Hold"
            'blSource.Rows.InsertAt(newrow2, 1)   'put it second
        ...
        Public Function GetExistingMembers(ByVal ProjectID As Integer) As DataTable
            ...
            sql &= "dbo.Contacts.FirstName + ' ' + dbo.Contacts.LastName AS Contact,Contacts_1.Name AS Company, dbo.Contacts.LastName as Last "
            sql &= "FROM dbo.Contacts LEFT OUTER JOIN dbo.Contacts AS Contacts_1 ON dbo.Contacts.ParentContactID = Contacts_1.ContactID RIGHT OUTER JOIN "
            sql &= "dbo.TeamMembers ON dbo.Contacts.ContactID = dbo.TeamMembers.ContactID "
            sql &= "WHERE ProjectID = " & ProjectID & " "
            sql &= "ORDER BY Last, TeamGroupDisplayOrder,TeamMemberDisplayOrder "
        ...
        Public Sub BuildSourceTree(ByVal tree As RadTreeView)
            ...
            Dim sql As String = ""
            Dim nPath As String = System.IO.Path.GetFullPath("~/")
            ...
            tbl = db.ExecuteDataTable("SELECT * FROM Contacts WHERE DistrictID = " & HttpContext.Current.Session("DistrictID") & " AND ContactType = 'Construction Manager' AND InActive<>1 ORDER BY Name ")
            For Each row As DataRow In tbl.Rows
                nodeMember = New RadTreeNode
                With nodeMember
                    .Text = ProcLib.CheckNullDBField(row("Name"))
            ...
            tbl = db.ExecuteDataTable("SELECT * FROM Contacts WHERE DistrictID = " & HttpContext.Current.Session("DistrictID") & " AND ContactType = 'General Contractor' AND InActive<>1 ORDER BY Name ")
            For Each row As DataRow In tbl.Rows
                nodeMember = New RadTreeNode
                With nodeMember
                    .Text = ProcLib.CheckNullDBField(row("Name"))
            ...
            tbl = db.ExecuteDataTable("SELECT * FROM Contacts WHERE DistrictID = " & HttpContext.Current.Session("DistrictID") & " AND ContactType = 'Design Professional' AND InActive<>1 ORDER BY Name ")
            For Each row As DataRow In tbl.Rows
                nodeMember = New RadTreeNode
                With nodeMember
                    .Text = ProcLib.CheckNullDBField(row("Name"))
            ...
            nodeParent = New RadTreeNode
            With nodeParent
                .Text = "District Representatives"
                .Value = "District Representatives"
                .ImageUrl = "images/users.png"
                .Attributes.Add("Type", "TeamGroup")
                .AllowDrag = False
                .AllowDrop = False
            ...
            tbl = db.ExecuteDataTable("SELECT * FROM Contacts WHERE DistrictID = " & HttpContext.Current.Session("DistrictID") & " AND ContactType = 'District Representative' AND InActive<>1 ORDER BY Name ")
            For Each row As DataRow In tbl.Rows
                nodeMember = New RadTreeNode
                With nodeMember
                    .Text = ProcLib.CheckNullDBField(row("Name"))
            ...
            nodeParent = New RadTreeNode
            With nodeParent
                .Text = "Inspectors Of Record"
                .Value = "Inspectors Of Record"
                .ImageUrl = "images/users.png"
                .Attributes.Add("Type", "TeamGroup")
                .AllowDrag = False
                .AllowDrop = False
            ...
            tbl = db.ExecuteDataTable("SELECT * FROM Contacts WHERE DistrictID = " & HttpContext.Current.Session("DistrictID") & " AND ContactType = 'Inspector Of Record' AND InActive<>1 ORDER BY Name ")
            For Each row As DataRow In tbl.Rows
                nodeMember = New RadTreeNode
                With nodeMember
                    .Text = ProcLib.CheckNullDBField(row("Name"))
