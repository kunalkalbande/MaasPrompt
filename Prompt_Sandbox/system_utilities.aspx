...
<script runat="server">
            ...
            Case "P01" '"Move Project"
                If Val(txtParm1.Text) > 0 And Val(txtParm2.Text) > 0 Then
                    Using db As New PromptDataHelper
                        ...
                        Dim nProjectID As Integer = txtParm1.Text
                        Dim nTargetCollegeID As Integer = txtParm2.Text
                        ...
                        Else   'Make the move
                            ...
                            ''''NOTE: THIS NEEDS TO BE DONE MANUALLY DUE TO BUG WITH SECURITY RIGHTS ON VM SERVER
                            ...
                            'update budget object codes
                            db.ExecuteNonQuery("UPDATE BudgetObjectCodes SET DistrictID = " & nTargetDistrictID & ",CollegeID = " & nTargetCollegeID & " WHERE ProjectID = " & nProjectID)

                            'update budget object code Estimates
                            db.ExecuteNonQuery("UPDATE BudgetObjectCodeEstimates SET DistrictID = " & nTargetDistrictID & ",CollegeID = " & nTargetCollegeID & " WHERE ProjectID = " & nProjectID)

                            
                            'update budget object code Estimates_Snapshots
                            db.ExecuteNonQuery("UPDATE BudgetObjectCodeEstimates_Snapshots SET DistrictID = " & nTargetDistrictID & ",CollegeID = " & nTargetCollegeID & " WHERE ProjectID = " & nProjectID)

                                                       
                            'update budget changelog
                            db.ExecuteNonQuery("UPDATE BudgetChangeLog SET CollegeID = " & nTargetCollegeID & " WHERE ProjectID = " & nProjectID)
                            
  
                            'update calendars
                            db.ExecuteNonQuery("UPDATE Calendars SET DistrictID = " & nTargetDistrictID & ",CollegeID = " & nTargetCollegeID & " WHERE ProjectID = " & nProjectID)

                            'update calendarEntries
                            db.ExecuteNonQuery("UPDATE CalendarEntries SET DistrictID = " & nTargetDistrictID & ",CollegeID = " & nTargetCollegeID & " WHERE ProjectID = " & nProjectID)
                            ...
                            'update contractline items
                            db.ExecuteNonQuery("UPDATE ContractLineItems SET DistrictID = " & nTargetDistrictID & ",CollegeID = " & nTargetCollegeID & " WHERE ProjectID = " & nProjectID)

                            'update JCAFChangeLog
                            db.ExecuteNonQuery("UPDATE JCAFChangeLog SET DistrictID = " & nTargetDistrictID & ",CollegeID = " & nTargetCollegeID & " WHERE ProjectID = " & nProjectID)

                            'update LedgerAccountEntries
                            db.ExecuteNonQuery("UPDATE LedgerAccountEntries SET DistrictID = " & nTargetDistrictID & ",CollegeID = " & nTargetCollegeID & " WHERE ProjectID = " & nProjectID)

                            'update LedgerAccountEntryAllocations
                            db.ExecuteNonQuery("UPDATE LedgerAccountEntryAllocations SET DistrictID = " & nTargetDistrictID & ",CollegeID = " & nTargetCollegeID & " WHERE ProjectID = " & nProjectID)

                            'update PassThroughEntries
                            db.ExecuteNonQuery("UPDATE PassThroughEntries SET DistrictID = " & nTargetDistrictID & ",CollegeID = " & nTargetCollegeID & " WHERE ProjectID = " & nProjectID)
                            ...
                            'update WorkflowLog
                            db.ExecuteNonQuery("UPDATE WorkflowLog SET DistrictID = " & nTargetDistrictID & ",CollegeID = " & nTargetCollegeID & " WHERE ProjectID = " & nProjectID)


                            result &= "Done moving Project " & nProjectID & " ! -- please move the Attahcments folder manually!"
    ...
    Private Sub RunPreReleaseCode()
        ...
        Using db As New PromptDataHelper
            ...
            sql = "SELECT * FROM Contacts WHERE ContactType = 'Company'  "
            db.FillDataTableForUpdate(sql)

            For Each row As DataRow In db.DataTable.Rows
                
                Dim ss As String = ""
                If Not IsDBNull(row("Comments")) Then
                    ss = Trim(row("Comments"))
                End If
                If Not IsDBNull(row("Keywords")) Then
                    ss = ss & vbCrLf & Trim(row("Keywords"))
                End If
                If Not IsDBNull(row("InsurPolicyDescription")) Then
                    ss = ss & vbCrLf & Trim(row("InsurPolicyDescription"))
                End If
                row("Comments") = ss
            Next
