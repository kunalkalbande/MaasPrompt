...
<script runat="server">
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else  'only do the following on first load
            ...
            'show the two new fields (Original Budget & Returned to Bond) only for COD
            If Session("DistrictID") = 56 Then
                txtOrigBudget.Enabled = True
                txtReturnedToBond.Enabled = True
                lblxOrigBudget.Visible = True
                lblxReturnedToBond.Visible = True
                
            Else
                txtOrigBudget.Visible = False
                txtReturnedToBond.Visible = False
                txtOrigBudget.Enabled = False
                txtReturnedToBond.Enabled = False
                lblxOrigBudget.Visible = False
                lblxReturnedToBond.Visible = False
...
<body>
   <form id="Form1" method="post" runat="server">
    ...
    <%--<asp:Label ID="lblcurrentbudget" Style="z-index: 117; left: 24px; position: absolute;
      ...
      <asp:HyperLink ID="butFlag" runat="server" ImageUrl="images/button_flag.gif" 
    ...
    <asp:ImageButton ID="butSave" Style="z-index: 153; left: 140px; position: absolute;
        top: 670px; right: 1184px;" TabIndex="45" runat="server" 
    ...
    <asp:ImageButton ID="butDelete" Style="z-index: 154; left: 445px; position: absolute;
        top: 671px; right: 879px;" TabIndex="50" runat="server" 
        OnClientClick="return confirm('You are about to delete this project.\n\nAre you sure you want to delete this project?')"
    ...
    <telerik:RadNumericTextBox ID="txtOrigBudget" Style="z-index: 119; left: 107px; position: absolute;
        top: 702px" Width="117px" TabIndex="20" runat="server" Enabled="False" ToolTip='This is the current budget for this project. Changes to this budget must be logged through the "change..." button on the right.'
        SelectionOnFocus="SelectAll" MinValue="0" AutoPostBack="False" 
         NumberFormat-DecimalDigits="2">
        <NumberFormat AllowRounding="True" DecimalDigits="2" PositivePattern="$ n"></NumberFormat>
    </telerik:RadNumericTextBox>
        
    <telerik:RadNumericTextBox ID="txtReturnedToBond" Style="z-index: 119; left: 415px; position: absolute;
        top: 703px" Width="117px" TabIndex="20" runat="server" Enabled="False" ToolTip='This is the current budget for this project. Changes to this budget must be logged through the "change..." button on the right.'
        SelectionOnFocus="SelectAll" MinValue="0" AutoPostBack="False" 
         NumberFormat-DecimalDigits="2" >
        <NumberFormat AllowRounding="True" DecimalDigits="2" PositivePattern="$ n"></NumberFormat>
    </telerik:RadNumericTextBox>
    <asp:Label runat="server" id="lblxReturnedToBond" CssClass="smalltext" Height="16px" Style="z-index: 108;
  left: 301px; position: absolute; top: 706px">Returned to Bond:</asp:Label>    
...
<asp:Label ID="Label334" Style="z-index: 107; left: 30px; position: absolute; top: 24px; height: 16px;"
  runat="server" CssClass="smalltext">Status:
     ...
     <p>
    <asp:Label runat="server" CssClass="smalltext" Height="16px" Style="z-index: 108;
  left: 19px; position: absolute; top: 705px" ID="lblxOrigBudget">Orig. Budget:</asp:Label>    
     </p>
