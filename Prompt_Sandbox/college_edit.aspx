...
<script runat="server">
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else  'only do the following on first load
            txtBondSiteDisplayOrder.Text = 0
    ...
    Private Sub butSave_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles butSave.Click
        ...
        txtBondSiteDisplayOrder.Text = Val(txtBondSiteDisplayOrder.Text)   'make sure this is a number
...
<body>
    ...
    <asp:ImageButton ID="butDelete" Style="z-index: 104; left: 201px; position: absolute;
         top: 682px" TabIndex="99" runat="server" 
         OnClientClick="return confirm('You are about to delete this College.\nAre you sure you want to delete this College?')"       
    ...
    <asp:Label ID="Label27" runat="server" CssClass="smalltext" Height="16px" Style="z-index: 141;
        left: 293px; position: absolute; top: 117px">Bond Site Display Order:</asp:Label>
    ...
    <asp:TextBox ID="txtBondSiteDisplayOrder" runat="server" 
         CssClass="EditDataDisplay" Style="z-index: 150;
        left: 429px; position: absolute; top: 112px; width: 42px;" TabIndex="25"></asp:TextBox>
