...
<script runat="server">
    ...
    Protected Sub butUpload_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Else
            Response.Redirect("attachments_manage_insurance.aspx?ParentRecID=" & nParentRecID & "&ParentType=" & sParentType)
        End If
    ...
    Protected Sub BuildMenu()
        ...
        With mm
            ...
            Else
                .NavigateUrl = "attachments_manage_insurance.aspx?ParentRecID=" & nParentRecID & "&ParentType=" & sParentType
            End If
