...
<script runat="server">
    ...
    Protected Sub txtFlagDescription_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
...
<body>
    ...
    <asp:TextBox ID="txtFlagDescription" Style="z-index: 102; left: 6px; position: absolute;
        ...
        TextMode="MultiLine" Width="427px" 
        ontextchanged="txtFlagDescription_TextChanged"></asp:TextBox>
    &nbsp;
