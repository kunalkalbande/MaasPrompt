    ...
    Protected Sub RadGrid1_ItemCreated(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridItemEventArgs) Handles RadGrid1.ItemCreated
        ...
        If (TypeOf e.Item Is GridDataItem) Then
            ...
            If nRoleName <> "TechSupport" Then
                ...
                'David D 10-25-17 fixed edit role to be in frame instead of pop-up
                linkButton.NavigateUrl = "admin_user_role_edit.aspx?RoleID=" & nRoleID
            End If
...
<body>
    ...
    <div align="right" id="header" style="float: right; z-index: 150; position: static;
        ...
        <asp:HyperLink ID="linkAddNew" runat="server" 
            NavigateUrl="~/admin_user_role_edit.aspx" ImageUrl="images/button_add_new.gif">add new</asp:HyperLink>
    </div>
     <br />
    <br />
...
//David D 10-25-17 removed pop-up edit window for in frame window
