...
<asp:Table ID="Table2" runat="server" Width="100%" BorderWidth="1px" BorderStyle="Solid"
    ...
    -- DEV -- &nbsp;&nbsp;&nbsp;&nbsp;</asp:Label>
            ...
            <asp:Label ID="Label1" runat="server" ForeColor="White" >Copyright &copy; </asp:Label>
                <asp:Label ID="lblYear" runat="server" ForeColor="White"></asp:Label>
                 <asp:Label ID="Label2" runat="server" ForeColor="White">&nbsp;&nbsp;MAAS Companies &nbsp;&nbsp;</asp:Label>
